...
root = pathlib.Path(r"C:\Users\ATG\Documents\Default Project\pharma-crm\backend")

# ============ Organization schema ============
schema = r'''from datetime import datetime
...
class OrganizationResponse(BaseModel):
    ...
    created_at: datetime
'''
(root / "app" / "schemas" / "organization.py").write_text(schema, encoding="utf-8")
print("OK - organization.py schema")

# ============ Organization routes ============
routes = r'''import json
...
def update_my_organization(
    ...
    return _org_to_response(organization)
'''
(root / "app" / "modules" / "organizations" / "routes.py").write_text(routes, encoding="utf-8")
print("OK - organizations routes")
print("Done!")