...
out = pathlib.Path(r"C:\Users\ATG\Documents\Default Project\pharma-crm\src\app\admin\users\page.tsx")
out.write_text(content, encoding="utf-8")

# Verify
text = out.read_text(encoding="utf-8")
if "التخصصات المسؤول عنها" in text:
    print("OK - specialties section present")
    print("Size:", len(text), "chars")
else:
    print("ERROR - still missing")